...
{
  int i, j, k, len_ret, len_temp1, len_temp2 = 0, check;
  unsigned long n;
  ...
  else if (l1 < l2 || cmp(&arr1[0], l1, &arr2[0], l2) < 0)
  {
    len_ret = sub(&ret_num[0], &arr2[0], l2, &arr1[0], l1);
    return (len_ret);
  }
...
//   ret_len = _mod(&ret_num_1[0], &arr_a_1[0], arr_len_a, &arr_b_1[0], arr_len_b);
...
//   ret_len = _mod(&ret_num_2[0], &arr_a_2[0], arr_len_a, &arr_b_2[0], arr_len_b);
...
//   ret_len = _mod(&ret_num_3[0], &arr_a_3[0], arr_len_a, &arr_b_3[0], arr_len_b);
...
//   ret_len = _mod(&ret_num_4[0], &arr_a_4[0], arr_len_a, &arr_b_4[0], arr_len_b);
...
//   ret_len = _mod(&ret_num_5[0], &arr_a_5[0], arr_len_a, &arr_b_5[0], arr_len_b);
...
//   ret_len = _mod(&ret_num_6[0], &arr_a_6[0], arr_len_a, &arr_b_6[0], arr_len_b);
...
//   ret_len = _mod(&ret_num_7[0], &arr_a_7[0], arr_len_a, &arr_b_7[0], arr_len_b);
//   re_str7 = itos(&ret_num_7[0], ret_len);
//   printf("%s / %s = %s, ret_len is %i\n", str_a_7, str_b_7, re_str7, ret_len);
//   printf("Check with 1, STRCMP is %i\n", strcmp("2967684239535", re_str7));
...
//   ret_len = _mod(&ret_num_8[0], &arr_a_8[0], arr_len_a, &arr_b_8[0], arr_len_b);
...
//   ret_len = _mod(&ret_num_9[0], &arr_a_9[0], arr_len_a, &arr_b_9[0], arr_len_b);
...
//   ret_len = _mod(&ret_num_10[0], &arr_a_10[0], arr_len_a, &arr_b_10[0], arr_len_b);
